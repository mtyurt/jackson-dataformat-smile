...
/**
 * User: M. Tarik Yurt  / mtyurt@gmail.com
 * Date: 30.09.2012
 * Time: 11:28
 * Implemented to trigger _seenNames and _seenStringValues bug while expanding
 */
public class TestGeneratorExpandArray extends SmileTestBase{

    public void testExpandSeenNames() throws IOException {
        ...
        String expectedResult = "-6,-127,97,49,33,-127,97,50,33,-127,97,51,33,-127,97,52,33,-127,97,53,33,-127,97,54,33,-127,97,55,33,-127,97,56,33,-127,97,57,33," +
                ...
                "-126,97,54,52,33,-126,97,54,53,-6,95,33,-5,-5";
                /*
                 * First "a32" is encoded as follows: -126,97,51,50
                 * Second one should be referenced: 95
                 */
        Assert.assertEquals(expectedResult,_dataToString(data));
    }

    public void testExpandSeenStringValues() throws IOException {
        ...
        */
        Assert.assertEquals(expectedResult,_dataToString(out.toByteArray()));
    }
